            ...
            <div className="container">
                <div className="d-flex align-items-center justify-content-between">
                    <div className="d-flex align-items-center">
                        <div className="mr-3 d-flex align-items-center" onClick={handlePhoneClick} style={{ cursor: 'pointer' }}>
                            <FontAwesomeIcon icon={faPhone} className="mr-1" />                
                            <span className="d-none d-lg-inline">{phoneNumber}</span>
                        </div>
                        <div className="mr-3 d-flex align-items-center" onClick={handleEmailClick} style={{ cursor: 'pointer' }}>
